...
export const ViewTravelStory = ({ storyInfo, onClose, onEditClick, onDeleteClick}) => {
  return (
        ...
        <div>
            <div className='flex-1 flex flex-col gap-2 py-4'>
                ...
                <div className='flex items-center justify-between gap-3'>
                    ...
                    <div className='inline-flex items-center gap-2 text-[13px] text-primary bg-primary/25 rounded px-2 py-1'>
